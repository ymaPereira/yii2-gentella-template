...
class m191024_171559_initial_data extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insertMenu();
        $this->insert('{{%user}}',[
                'id'=>1, 'username'=>'admin', 'auth_key'=>'aVeQxCxiyI9lCTbg_J9i13LV1tGc6X8R', 
                'password_hash'=>'$2y$13$5qgMnZRqOXR5klpeX0zh2OJJ6/tnzmgQswPmFjp9g/bPpEABK/Cza', 
                'password_reset_token'=>NULL, 'email'=>'admin@gmail.com', 'status'=>10, 'created_at'=>1551142509, 'updated_at'=>1551142509
        ]);

        $this->insert('{{%auth_assignment}}',[
                'item_name'=>'Admin', 'user_id'=>'1','created_at'=>1551142509
        ]);
    }
    ...
    */
    ...
    private function insertMenu(){
        $this->insert('{{%menu}}',[
                'id'=>1, 'name'=>'Gestão de Acesso','parent'=>NULL,'route'=>NULL,'order'=>0
        ]);
        $this->insert('{{%menu}}',[
                'id'=>2, 'name'=>'Gestão de Perfil','parent'=>1,'route'=>'profile/index','order'=>1
        ]);
        $this->insert('{{%menu}}',[
                'id'=>3, 'name'=>'Gestão de Permissão','parent'=>1,'route'=>'permission/index','order'=>2
        ]);
        $this->insert('{{%menu}}',[
                'id'=>4, 'name'=>'Gestão de Menu','parent'=>1,'route'=>'menu/index','order'=>3
        ]);
        $this->insert('{{%menu}}',[
                'id'=>5, 'name'=>'Gestão de Utilizadores','parent'=>1,'route'=>'user/index','order'=>4
        ]);
    }
}
